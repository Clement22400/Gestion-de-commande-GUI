...
{
    public partial class FormulaireModifierContenuCommande : Form
    {
        public FormulaireModifierContenuCommande()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (cbProduits.SelectedIndex != -1 & inputQuantité.Text != "" & nombre.Match(inputQuantité.Text).Success)
            {
                ...
                ModifierContenuCommande.listContenuModifierShare.Items.Add(new ListViewItem(items));
